...
\begin{figure}[!htb]
    ...
    %     \caption{}
    %     \label{fig:lstm-models-port:64}
    % \end{subfigure}
    % \begin{subfigure}{.45\textwidth}
    %     \includegraphics[width=\textwidth]{figure/lstm_model_32.png}
    %     \caption{}
    %     \label{fig:lstm-models-port:32}
    % \end{subfigure}
    % \begin{subfigure}{.45\textwidth}
    %     \includegraphics[width=\textwidth]{figure/lstm_model_16.png}
    %     \caption{}
    %     \label{fig:lstm-models-port:16}
    % \end{subfigure}
    % \begin{subfigure}{.45\textwidth}
    %     \includegraphics[width=\textwidth]{figure/lstm_model_8.png}
    %     \caption{}
    %     \label{fig:lstm-models-port:8}
    % \end{subfigure}
    \includegraphics[width=\textwidth]{figure/lstm_model_64.png}
